...
urlpatterns = [
	...
	path('movement/', views.movements, name='movement_list'),
	path('movement/new', views.movement_new, name='movement_new'),
	path('movement/<int:pk>/', views.movement_details, name='movement_details'),
]